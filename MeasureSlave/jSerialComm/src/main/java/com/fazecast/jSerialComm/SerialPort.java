...
public final class SerialPort
{
	...
	private static volatile boolean isAndroid = true;
	...
	static
	{
		...
		libraryPath = "src/Android/armeabi-v7a";
		...
		try
		{
			...
			{
				libraryPath = libraryPath.replace("src/Android/", "");
				fileContents = Common.application.getResources().getAssets().open((libraryPath + "/" + fileName));
